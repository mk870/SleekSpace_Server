...
func emailForVerificationCodeHtml(firstName string, verificationCode string) string {
	return ("<h2>Hi " + firstName + "</h2> <p>Welcome to <span style=\"color: rgb(77, 9, 205);font-size: 14px;font-weight:bold;\">SleekSpace</span>. Please enter this code to activate your account: " + verificationCode + "</p></p> This code will expire in 30 minutes. See you soon.</p>")
}
